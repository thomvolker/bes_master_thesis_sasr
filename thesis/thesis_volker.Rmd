...
1.	Hoe kunnen we hard maken dat we álle relevante studies gevonden hebben (en dus binnen de grenzen van het mogelijke de relevante data hebben). 
...
```{r density, dpi = 300, warning = F, message = F, echo = F, fig.width=7.5, fig.height = 3.75, dev='cairo_pdf', fig.cap = "Prior and posterior density for two regression parameters."}
library(ggplot2)
library(ggdensity)
library(extrafont)
